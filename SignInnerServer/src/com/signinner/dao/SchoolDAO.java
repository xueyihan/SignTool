...
public class SchoolDAO {
	...
	public School findById(java.lang.Integer id) {
		...
		try {
			School instance = (School) getCurrentSession().get(
					"com.signinner.dao.School", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<School> findByExample(School instance) {
		...
		try {
			List<School> results = (List<School>) getCurrentSession()
					.createCriteria("com.signinner.dao.School")
	...
	public List<School> findByName(Object name) {
